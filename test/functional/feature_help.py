...
"""Verify that starting bedrockcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bedrockcoin with -h for help text")
        ...
        self.log.info("Start bedrockcoin with -version for version information")
        ...
        self.log.info("Start bedrockcoind with -fakearg to make sure it does not start")
