# Support for Output Descriptors in BedrockCoin Core

Since BedrockCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `brk1...` for mainnet or `tbrk1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing BedrockCoin Core wallets, a convenience function `combo` is
