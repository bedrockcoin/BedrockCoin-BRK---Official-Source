...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bedrockcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bedrockcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bedrockcoin transaction\n" +
            "or:     bedrockcoin-tx [options] -create [commands]   Create hex-encoded bedrockcoin transaction\n" +
            "\n";
