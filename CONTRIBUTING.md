Contributing to BedrockCoin Core
============================

The BedrockCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the BedrockCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/bedrockcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bedrockcoin-qt
...
The following applies to code changes to the BedrockCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BedrockCoin
Network Protocol consensus changes.

Whether a pull request is merged into BedrockCoin Core rests with the project merge
...
Patches that change BedrockCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BedrockCoin consensus, it must have been
...
The project leader is the release manager for each BedrockCoin Core release.
