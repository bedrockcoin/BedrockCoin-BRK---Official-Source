...
bech32_templates = [
  ...
  ('brk',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('brk',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('brk',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('brk',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tbrk',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbrk',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbrk',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbrk',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tbrk',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbrk',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbrk',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbrk',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rbrk',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rbrk',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rbrk',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rbrk', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tbrk',   17, 32, Encoding.BECH32M, False, False, False),
  ('rbrk',  3,  1, Encoding.BECH32M, False, False, False),
  ('brk',   15, 41, Encoding.BECH32M, False, False, False),
  ('tbrk',    0, 16, Encoding.BECH32,  False, False, False),
  ('rbrk',  0, 32, Encoding.BECH32,  True,  False, False),
  ('brk',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tbrk',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rbrk',  0, 20, Encoding.BECH32,  False, False, True),
  ('brk',    0, 20, Encoding.BECH32M, False, False, False),
  ('tbrk',    0, 32, Encoding.BECH32M, False, False, False),
  ('rbrk',  0, 20, Encoding.BECH32M, False, False, False),
  ('brk',    1, 32, Encoding.BECH32,  False, False, False),
  ('tbrk',    2, 16, Encoding.BECH32,  False, False, False),
  ('rbrk', 16, 20, Encoding.BECH32,  False, False, False),
]
